package org.cachestudy.writeitbyself.ming;
...
import org.cachestudy.writeitbyself.MyCache;
import org.cachestudy.writeitbyself.store.impl.BasicDataStore;

public class CsCache<K, V> implements Cache<K, V> {

	private MyCache<K, V> csCache = new MyCache<K, V>(new BasicDataStore<K, V>());
	private volatile boolean isClosed;
	

	private String cacheName;

	private CsCacheManager cacheManager;

	private Configuration<K, V> configuration;

	public CsCache(CsCacheManager cacheManager, String cacheName, Configuration<K, V> configuration) {
